...
namespace HW5
{
    public partial class Page4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string url = @"http://localhost:5965/Service1.svc/GetTraffic/" + (String) Cache["zipcode"];
            ...
            //Label3.Text += "<h2> Traffic Around " + (String) Cache["city"] + "</h2> </br>";

            for (int p = 0; p < starttimesplitted.Length - 1; p++)
            {
                Label3.Text += "<b>" + fullDescsplitted[p] + "</b></br> Start-Time:" + starttimesplitted[p] + "</br> End-Time:" + endtimesplitted[p] + "</br></br>";
            }
        }
